...
public class BasicDocument extends Document 
{
	...
	{
		//passes the text to the superclass
		super(text);
	}
	...
	public int getNumSentences()
	{
        ...
        // if you need help.
		//regex here is matching everything but sentence ending punctuation to return all sentences
	...
	public static void main(String[] args)
	{
		...
		Document doc = new BasicDocument("many???  Senteeeeeeeeeences are");
		System.out.println("F SCORE " + doc.getFleschScore());
