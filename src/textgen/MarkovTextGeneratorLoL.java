...
public class MarkovTextGeneratorLoL implements MarkovTextGenerator {
	...
	public String generateText(int numWords) {
	    // TODO: Implement this method
		if(wordList.isEmpty() || numWords < 1) {return "";}
		String currWord = starter;
		String output = "";
		output = output + currWord;
		int wordCount = 1;
		while(wordCount < numWords) {
			String newWord = findNode(currWord).getRandomNextWord(rnGenerator);
...
class ListNode
{
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((nextWords == null) ? 0 : nextWords.hashCode());
	...
	public String getRandomNextWord(Random generator)
	{
		...
		int size = this.nextWords.size();
		if (size == 0) {
			return nextWords.get(0);
		}
		String word = this.nextWords.get(generator.nextInt(size));
	    return word;
	}
